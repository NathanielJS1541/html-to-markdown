...
def parse_contents(
...
) -> html_to_markdown.challenge.Challenge | None:
    ...
    Returns:
        html_to_markdown.challenge.Challenge | None: A challenge object representing the parsed challenge data, or None if an error was encountered.
    """
    ...
    return html_to_markdown.challenge.Challenge(
        challenge_number,
        response.url,
        title,
        description_text,
...
def replace_tag_with_markdown_url(
    ...
    if challenge_match:
        ...
        url = f"{html_to_markdown.scraper.CHALLENGE_URL_BASE}{challenge_number}"
        ...
        # matched.
        remote_url = html_to_markdown.scraper.URL_BASE + url
        ...
        url = f"{html_to_markdown.scraper.URL_BASE}{url}"
