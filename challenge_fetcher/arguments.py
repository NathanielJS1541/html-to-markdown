...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="The GitHub MarkDown renderer currently does not display the LaTeX operator \operatorname correctly. Enabling this flag adds a workaround to allow them to be rendered correctly. See https://github.com/github/markup/issues/1688.",
        action="store_true",
    )
